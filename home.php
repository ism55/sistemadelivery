              ...
              <!--  ################################################################# -->
                  <div class="container">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col">
                        <label  class="col-form-label">Agregar</label>
                        <button type="button" id="btn_combo4mas" class="btn btn-lg btn-primary btn-block">+</button>
                      </div>
                      <div class="col">
                        <label class="col-form-label">Quitar</label>
                        <button type="button" id="btn_combo4menos" class="btn btn-lg btn-primary btn-block">-</button>
                      </div>
                      <div class="col">
                   ...
                   <!--  ################################################################# -->
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col">
                        <label  class="col-form-label">Agregar</label>
                        <button type="button" id="btn_combo5mas" class="btn btn-lg btn-primary btn-block">+</button>
                      </div>
                      <div class="col">
                        <label class="col-form-label">Quitar</label>
                        <button type="button" id="btn_combo5menos" class="btn btn-lg btn-primary btn-block">-</button>
                      </div>
                      <div class="col">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col">
                        <label  class="col-form-label">Agregar</label>
                        <button type="button" id="btn_combo6mas" class="btn btn-lg btn-primary btn-block">+</button>
                      </div>
                      <div class="col">
                        <label class="col-form-label">Quitar</label>
                        <button type="button" id="btn_combo6menos" class="btn btn-lg btn-primary btn-block">-</button>
                      </div>
                      <div class="col">
                ...
                <!--  ################################################################# -->
                  <div class="container">
                    <div class="row form-group">
                      ...
                      <div class="col">
                        <label  class="col-form-label">Agregar</label>
                        <button type="button" id="btn_combo1duomas" class="btn btn-lg btn-primary btn-block">+</button>
                      </div>
                      <div class="col">
                        <label  class="col-form-label">Quitar</label>
                        <button type="button" id="btn_combo1duomenos" class="btn btn-lg btn-primary btn-block">-</button>
                      </div>
                      <div class="col">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col">
                        <label  class="col-form-label">Agregar</label>
                        <button type="button" id="btn_combo2duomas" class="btn btn-lg btn-primary btn-block">+</button>
                      </div>
                      <div class="col">
                        <label class="col-form-label">Quitar</label>
                        <button type="button" id="btn_combo2duomenos" class="btn btn-lg btn-primary btn-block">-</button>
                      </div>
                      <div class="col">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col">
                        <label  class="col-form-label">Agregar</label>
                        <button type="button" id="btn_combo3duomas" class="btn btn-lg btn-primary btn-block">+</button>
                      </div>
                      <div class="col">
                        <label class="col-form-label">Quitar</label>
                        <button type="button" id="btn_combo3duomenos" class="btn btn-lg btn-primary btn-block">-</button>
                      </div>
                      <div class="col">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col">
                        <label  class="col-form-label">Agregar</label>
                        <button type="button" id="btn_combo4duomas" class="btn btn-lg btn-primary btn-block">+</button>
                      </div>
                      <div class="col">
                        <label class="col-form-label">Quitar</label>
                        <button type="button" id="btn_combo4duomenos" class="btn btn-lg btn-primary btn-block">-</button>
                      </div>
                      <div class="col">

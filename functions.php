...
<script>
  ...
  var tempGenerico;
  var tempSector;
  //tempGenerico = $("#zonaPersonalizada").detach();
  $('body').ready(function() {
    $("#zonaPersonalizada").hide();
  })


  var generico = "<div id='zonaPersonalizada'>" +
  ...
  $("#boton").click(function() {
    ...
    // $( "#prueba1" ).toggleClass( "off" );
    /*
    if (valor) {
      valor.appendTo("#nuevo");
      valor = null;
    } else {
      valor = $("#prueba1").detach();
    }
    */
    if ($("#boton").is(":checked")) {
      //tempSector = $("#inputSector").detach();
      //$("#generico").remove();
      //$("#genericoValor").remove();
      //$("#sectorEnvio").append(generico);
      //tempGenerico.appendTo("#sectorEnvio");
      $("#zonaPersonalizada").show();
      $("#inputSector").hide();
      ...
      $("#inputSector").show();
      //tempGenerico = $("#zonaPersonalizada").detach();
      //tempSector.appendTo("#sectorEnvio");
      //$("#generico").remove();
      //$("#genericoValor").remove();
    }
  ...
  $("#inputSector").change(function() {
    $("#nombreZona").text(
      $("#inputSector").find("option:selected").attr("name")
    );
  });
  ...
  $("#inputzonaextra").change(function() {
  ...
  $("#inputSector").change(function() {
    $("#pagoDelivery").text($("#inputSector").val());
  });

  $("#genericoValor").change(function() {
    $("#pagoDelivery").text($("#genericoValor").val());
  });
  /*
  ...
  var intervalo = window.setInterval(function() {
    ...
    var auxIndicador = "";
    if (totalFaltante < 0) {
      auxIndicador = " (Vuelto a cliente)";
      totalFaltante = Math.abs(totalFaltante);
    } else if (totalFaltante > 0) {
      auxIndicador = " (Falta por pagar)";
      totalFaltante = Math.abs(totalFaltante);
    }
    $("#pagoFaltante").text(
      totalFaltante.toFixed(2) +
  ...
  function SendToClient() {
    ...
    if ($("#tipoPago").val() == "PayPal") {
      ...
      var auxval =
        ...
        "\n\n" +
        "Por favor, hacer el pago a: " +
        "\n" +
        "jing23siet@gmail.com\n" +
        "Nota de pago:  chinocaracasdelivery";
      ...
      var auxval =
        ...
        "Tasa de cambio: " + String(numberWithCommas(parseFloat($("#tasaDia").val()))) + "Bs" +
        "\n\n" +
        "Por favor, hacer el pago en Efectivo o a PayPal con los siguientes datos: " +
        "\n" +
        "jing23siet@gmail.com\n" +
        "Nota de pago:  chinocaracasdelivery\n\n" +
        "Bolívares a:\n" +
  ...
  function SendToClient2() {
    ...
    var auxval = "Restante: " + $("#pagoFaltante").text();
    document
  ...
  function imprSelec(X) {
    ...
    ventimp.document.write("<br>");
    ventimp.document.write("<br>");
    ventimp.document.write("Restante: " + $("#pagoFaltante").text())
    ventimp.document.write("<br>");
    ventimp.document.write("<br>");

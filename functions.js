...
var precioMegaCombo3 = 21;
var precioMegaCombo4 = 28;
var precioMegaCombo5 = 28;
var precioMegaCombo6 = 28;
var precioMegaCombo7 = 21;
var precioCombo1duo = 16;
var precioCombo2duo = 16;
var precioCombo3duo = 21;
var precioCombo4duo = 21;
var precioCombo5duo = 18;
var precioCombo6duo = 18;
var precioCombo7duo = 18;
var preciokombo1 = 9;
var preciokombo2 = 7;
var preciokombo3 = 6;
var preciokombo4 = 8;
...
var preciokowloon = 8;
var preciopolloycamarones = 7;
var preciolmvegetariano = 6;
var preciolmpollo = 7;
var preciolmcerdo = 7;
var preciolmespecial = 8;
var preciolmcamarones = 8;
var preciolmkowloon = 9;
var preciolmcarne = 8;
var preciolmpolloycamarones = 8;
...
var preciocscerdo = 7;
var preciocscarne = 8;
var preciocscamarones = 8;
var preciocspolloyc = 8;
...
var preciocomboclasico1 = 18;
var preciocomboclasico2 = 18;
var preciocombosuper1 = 35;
var preciocombosuper2 = 35;
var preciocombosuper3 = 32;
var preciocmvegetariano = 6;
var preciocmpollo = 7;
var preciocmcerdo = 7;
var preciocmespecial = 8;
var preciocmkowloon = 9;
var preciocmcarne = 8;
var preciocmcamarones = 8;
var preciocmpolloycamarones = 8;
var preciocerdocurry = 10;
var preciocerdoostra = 10;
var preciocsjamon = 7;
...
function sumarTodo() {
  return (
    parseInt($("input[name=totalcombo1]").val()) +
    parseInt($("input[name=totalcombo2]").val()) +
    parseInt($("input[name=totalcombo3]").val()) +
    parseInt($("input[name=totalcombo4]").val()) +
    parseInt($("input[name=totalcombo5]").val()) +
    parseInt($("input[name=totalcombo6]").val()) +
    parseInt($("input[name=totalcombo7]").val()) +
    parseInt($("input[name=totalcombo1duo]").val()) +
    parseInt($("input[name=totalcombo2duo]").val()) +
    parseInt($("input[name=totalcombo3duo]").val()) +
    parseInt($("input[name=totalcombo4duo]").val()) +
    parseInt($("input[name=totalcombo5duo]").val()) +
    parseInt($("input[name=totalcombo6duo]").val()) +
    parseInt($("input[name=totalcombo7duo]").val()) +
    parseInt($("input[name=totalkombo1]").val()) +
    parseInt($("input[name=totalkombo2]").val()) +
    parseInt($("input[name=totalkombo3]").val()) +
    parseInt($("input[name=totalkombo4]").val()) +
    parseInt($("input[name=totalkombo5]").val()) +
    parseInt($("input[name=totalkombo6]").val()) +
    parseInt($("input[name=totalkombo7]").val()) +
    parseInt($("input[name=totalkombo8]").val()) +
    parseInt($("input[name=totalvegetariano]").val()) +
    parseInt($("input[name=totalpollo]").val()) +
    parseInt($("input[name=totaljamon]").val()) +
    parseInt($("input[name=totalcerdo]").val()) +
    parseInt($("input[name=totalespecial]").val()) +
    parseInt($("input[name=totalcamarones]").val()) +
    parseInt($("input[name=totallmvegetariano]").val()) +
    parseInt($("input[name=totallmpollo]").val()) +
    parseInt($("input[name=totallmcerdo]").val()) +
    parseInt($("input[name=totallmespecial]").val()) +
    parseInt($("input[name=totallmcamarones]").val()) +
    parseInt($("input[name=totalpagridulce]").val()) +
    parseInt($("input[name=totalpsoya]").val()) +
    parseInt($("input[name=totalpcurry]").val()) +
    parseInt($("input[name=totalpostras]").val()) +
    parseInt($("input[name=totalpajonjoli]").val()) +
    parseInt($("input[name=totalpasado]").val()) +
    parseInt($("input[name=totalcostras]").val()) +
    parseInt($("input[name=totalccurry]").val()) +
    parseInt($("input[name=totalcbrocoli]").val()) +
    parseInt($("input[name=totalcvegetales]").val()) +
    parseInt($("input[name=totalcostilla]").val()) +
    parseInt($("input[name=totalcerdoa]").val()) +
    parseInt($("input[name=totalcerdosyp]").val()) +
    parseInt($("input[name=totalcerdocurry]").val()) +
    parseInt($("input[name=totalcerdoostra]").val()) +
    parseInt($("input[name=totallumpias]").val()) +
    parseInt($("input[name=totalwantonf]").val()) +
    parseInt($("input[name=totalfideoss]").val()) +
    parseInt($("input[name=totalfuyong]").val()) +
    ...
    parseInt($("input[name=totalswantonmien]").val()) +
    parseInt($("input[name=totalcsvegetales]").val()) +
    parseInt($("input[name=totalcspollo]").val()) +
    parseInt($("input[name=totalcscerdo]").val()) +
    parseInt($("input[name=totalcscarne]").val()) +
    parseInt($("input[name=totalcscamarones]").val()) +
    parseInt($("input[name=totalcspolloyc]").val()) +
    parseInt($("input[name=totalcomboclasico2]").val()) +
    parseInt($("input[name=totalcomboclasico1]").val()) +
    parseInt($("input[name=totalcombosuper3]").val()) +
    parseInt($("input[name=totalcombosuper2]").val()) +
    parseInt($("input[name=totalcombosuper1]").val()) +
    parseInt($("input[name=totalkowloon]").val()) +
    parseInt($("input[name=totalpolloycamarones]").val()) +
    parseInt($("input[name=totallmkowloon]").val()) +
    parseInt($("input[name=totallmpolloycamarones]").val()) +
    parseInt($("input[name=totallmcarne]").val()) +
    parseInt($("input[name=totalcmvegetariano]").val()) +
    parseInt($("input[name=totalcmpollo]").val()) +
    parseInt($("input[name=totalcmcerdo]").val()) +
    parseInt($("input[name=totalcmespecial]").val()) +
    parseInt($("input[name=totalcmcamarones]").val()) +
    parseInt($("input[name=totalcmkowloon]").val()) +
    parseInt($("input[name=totalcmcarne]").val()) +
